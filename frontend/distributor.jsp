...
<body>
	<div class="header">
			...
			<marquee><h6><font color="black">We Bring Good Things To Life...</font></h6></marquee>
		</div>
...
try{
	...
	String query = " INSERT into distributor(Did, Name, Sex, CompanyName, ModelName, PhNo, Price, Amtpaid, BalanceAmt, Quantity, Date) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	PreparedStatement ps = conn.prepareStatement(query);
			...
			String phno=request.getParameter("dphno");
			String price=request.getParameter("dprice");
			String amt=request.getParameter("amount");
			String bamt=request.getParameter("bamount");
			String qty=request.getParameter("dquantity");
