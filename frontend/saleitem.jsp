...
try{
	...
	String query = " INSERT into sales(date,billno,customername,address, phno, companyname, modelname, price, quantity, totalamt) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	PreparedStatement ps = conn.prepareStatement(query);
			...
			String cmpyname=request.getParameter("cname");
